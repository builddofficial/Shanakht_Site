      ...
      <div id="contact" className="flex flex-col gap-7 md:flex-row md:gap-0 justify-between items-center border bg-background border-[#FEEFDC] rounded-lg shadow-lg px-6 py-8 max-w-4xl mx-auto relative -mb-10 mt-32 ">
        <div className="">
          ...
          <h1 className="text-3xl text-[#777] w-10/12">
            ...
            <span className="text-primary2">Subscribe</span> to our newsletter.
          </h1>
        </div>
        <div className="flex">
          <input
            ...
            className="border border-primary2 p-2"
          />
          <button className="bg-primary2 text-white px-4 py-2">
            Subscribe
          </button>
        </div>
      </div>
      ...
      <div className="w-full bg-primary">
        <div className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row justify-between pt-20 pb-7 gap-7 md:gap-0">
          <div className="flex flex-col justify-evenly py-7">
            ...
            <div>
              <h1 className="text-background font-semibold text-3xl md:text-4xl pt-7">
                Shanakht
              </h1>
              <h1 className="text-background font-semibold text-xl md:text-2xl">
                shanakht.official10@gmail.com
              </h1>
            </div>
          </div>
        ...
        <div className="w-full text-center mx-auto pb-1 pt-4">
          <p className="text-white text-xl md:text-2xl font-light">
            © 2021 Shanakht. All rights reserved
          </p>
        </div>
      </div>
    </>
