  ...
  return (
    <>
        <div className='max-w-screen-xl mx-auto px-4 my-48'>
            <h1 className='font-primary text-7xl font-bold text-primary mb-4'>JOIN OUR COMMUNITY</h1>
            <div className='flex gap-4'>
                <div className='space-y-8'>
                    <p className='text-primary2 font-semibold text-3xl'>Shanakht welcomes volunteers to help with content creation, event organization, and outreach efforts.</p>
                    <div className='font-semibold text-2xl space-y-4 w-11/12'>
                ...
                <div className='relative'>
                    ...
                    <Image src="/assets/joinUs.svg" alt="Join Us" className='absolute -top-32 -right-32' width={291} height={200}/>
                </div>
            </div>
