      ...
      <div className="max-w-screen-xl mx-auto px-4 my-48">
        ...
        <div className="flex gap-4 flex-col xl:flex-row">
          ...
          <div className="relative">
            ...
            <Image
              src="/assets/joinUs.svg"
              alt="Join Us"
              className="absolute -top-32 -right-12 hidden md:block"
              width={291}
              height={200}
            />
          </div>
        ...
        <div className="flex items-center justify-between my-7 flex-col xl:flex-row gap-7">
          <div className="space-y-5">
            ...
            <p className="font-medium text-2xl md:text-3xl w-11/12">
              ...
              platform.{" "}
              <Link
                href="https://docs.google.com/forms/d/e/1FAIpQLSemkHoPOpvNdEwDGqIADBYUQMwA3Og3g3E7N6rG8TOwF8LZXg/viewform"
                className="text-primary2 underline"
              >
                Fill out
              </Link>{" "}
              our application form and submit a brief statement of interest, to
              join us!
            </p>
          </div>
